...
namespace Beeant.Distributed.Outside.Pay.Controllers
{
    ...
    public class BalancePayController : PayController
    {
        #region 创建
        /// <summary>
        /// 创建
        ...
        {
            return Create(model, PaylineType.Balance);
        }
        /// <summary>
        /// 通知
        /// </summary>
        ...
        {
            return Process(PaylineType.Balance);
        }
        /// <summary>
        /// 创建
        /// </summary>
        ...
        {
            return Refund(model, PaylineType.Balance);
        }
