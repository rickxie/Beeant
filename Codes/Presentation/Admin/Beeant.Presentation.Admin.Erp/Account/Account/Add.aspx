<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Account.Account.Add" MasterPageFile="~/Datum.Master" ValidateRequest="false" %>
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    ...
    <table class="tb">
       <tr>
          ...
          <tr>
            <td class="font">密码</td>
            <td class="text"><input id="txtPassword" runat="server" class="input" type="password"  BindName="Password" SaveName="Password"   /></td>
            <td class="font">确认密码</td>
            <td class="text"><input id="txtSurePassword" runat="server" class="input" type="password" ValidateName="Password"  /> </td>
        </tr>
