<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Basedata.Unit.List" %>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="mtext">
                            <asp:CheckBoxList ID="ckSelectList" runat="server">
                                ...
                                <asp:ListItem  Selected="True" Value="Name" Text="单位名称" ></asp:ListItem>
                                <asp:ListItem  Selected="True" Value="Sequence" Text="排序" ></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td class="mtext">
                            <asp:DropDownList ID="ddlOrderbyList" runat="server">
                                ...
                                <asp:ListItem  Value="Name" Text="单位名称" ></asp:ListItem>
                        ...
                        <td >
                            <asp:RadioButtonList ID="rdOrderbyType" runat="server" RepeatDirection="Horizontal">
                                 <asp:ListItem  Value="asc" Text="升序"  Selected="True"></asp:ListItem>
            ...
            <div class="list">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="单位名称"  ItemStyle-CssClass="left">
                            <ItemTemplate>
                                <%#Eval("Name")%>
                            </ItemTemplate>
                        </asp:TemplateField>
