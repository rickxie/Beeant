<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Basedata.PayType.List" MasterPageFile="~/Main.Master" %>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Selected="True" Value="Name" Text="名称" ></asp:ListItem>
                      ...
                      <asp:ListItem  Selected="True" Value="Url" Text="支付地址" ></asp:ListItem>
        ...
        <asp:TemplateField HeaderText="名称"  ItemStyle-CssClass="left">
            ...
            <ItemTemplate>
                <%#Eval("Tag")%>
                   ...
                   <asp:TemplateField HeaderText="支付地址"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("Url")%>
            </ItemTemplate>
        </asp:TemplateField>
