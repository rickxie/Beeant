<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Basedata.Album.List" MasterPageFile="~/Main.Master" %>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Selected="True" Value="Tag" Text="标签" ></asp:ListItem>
                     <asp:ListItem  Selected="True" Value="PageSize" Text="每页大小" ></asp:ListItem>
                          <asp:ListItem  Selected="True" Value="Width" Text="宽度" ></asp:ListItem>
                          <asp:ListItem  Selected="True" Value="Height" Text="高度" ></asp:ListItem>
                      <asp:ListItem  Selected="True" Value="FrontFileName" Text="封面" ></asp:ListItem>
                      <asp:ListItem  Selected="True" Value="BackFileName" Text="背面" ></asp:ListItem>
                      <asp:ListItem  Selected="True" Value="AboutFileName" Text="介绍页" ></asp:ListItem>
        ...
        <asp:TemplateField HeaderText="名称"  ItemStyle-CssClass="left">
         ...
         <asp:TemplateField HeaderText="标签"  ItemStyle-CssClass="left">
            <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="每页大小"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("PageSize")%>
            </ItemTemplate>

        </asp:TemplateField>
                 <asp:TemplateField HeaderText="宽度"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("Width")%>
            </ItemTemplate>

        </asp:TemplateField>
                 <asp:TemplateField HeaderText="高度"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("Height")%>
            </ItemTemplate>

        </asp:TemplateField>
                      <asp:TemplateField HeaderText="封面"  ItemStyle-CssClass="left">
            <ItemTemplate>
              <img src=" <%#Eval("FullFrontFileName")%>" class="img" /> 
            </ItemTemplate>
        </asp:TemplateField>
                      <asp:TemplateField HeaderText="背面"  ItemStyle-CssClass="left">
            <ItemTemplate>
              <img src=" <%#Eval("FullBackFileName")%>" class="img" /> 
            </ItemTemplate>
        </asp:TemplateField>
                      <asp:TemplateField HeaderText="介绍面"  ItemStyle-CssClass="left">
            <ItemTemplate>
                 <img src=" <%#Eval("FullAboutFileName")%>" class="img" /> 
            </ItemTemplate>
        </asp:TemplateField>
