<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Basedata.Delivery.List" MasterPageFile="~/Main.Master" %>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext"> 
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="LimitCount" Text="限量" Selected="True"></asp:ListItem>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="城市"  ItemStyle-CssClass="left">
            <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="限量"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("LimitCount")%>小时
            </ItemTemplate>
        </asp:TemplateField>
