<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Basedata.Currency.List" MasterPageFile="~/Main.Master" %>
    ...
    <ContentTemplate>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Selected="True" Value="Name" Text="名称" ></asp:ListItem>
                       <asp:ListItem  Selected="True" Value="Code" Text="代码" ></asp:ListItem>
            ...
            <td class="mtext">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                     ...
                     <asp:ListItem  Value="Name" Text="名称" ></asp:ListItem>
                      <asp:ListItem Value="Code" Text="代码" ></asp:ListItem>
                     <asp:ListItem  Selected="True" Value="InsertTime" Text="录入时间" ></asp:ListItem>
                     <asp:ListItem  Value="UpdateTime" Text="编辑时间" ></asp:ListItem>
                </asp:DropDownList>
            </td>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="名称"  ItemStyle-CssClass="left">
         ...
         <asp:TemplateField HeaderText="代码"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <%#Eval("Code")%>
            </ItemTemplate>
        </asp:TemplateField>
