<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Product.Rule.List" MasterPageFile="~/Main.Master" %>
    ...
    <ContentTemplate>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext"> 
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="Pattern" Text="表达式"  Selected="True"></asp:ListItem>
                     <asp:ListItem  Value="Sequence" Text="排序" Selected="True"></asp:ListItem>
                     <asp:ListItem  Value="IsRange" Text="是否范围验证" Selected="True"></asp:ListItem>
        ...
        <tr>
            ...
            <td class="mtext">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                     ...
                     <asp:ListItem  Value="Pattern" Text="表达式"  ></asp:ListItem>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="名称"  ItemStyle-CssClass="left">
         ...
         <asp:TemplateField HeaderText="表达式"  ItemStyle-CssClass="left status">
            <ItemTemplate>
                <%#Eval("Pattern")%>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="是否范围验证"  ItemStyle-CssClass="left Sequence">
            <ItemTemplate>
                <%#Eval("IsRangeName")%>
            </ItemTemplate>
        </asp:TemplateField>
