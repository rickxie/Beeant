<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Order.OrderPay.List" MasterPageFile="~/Datum.Master" %>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Value="Number" Text="流水号" Selected="True" ></asp:ListItem>
         ...
         <asp:TemplateField HeaderText="编号"  ItemStyle-CssClass="center">
            ...
            <ItemTemplate>
                <%#Eval("Name")%>
                   ...
                   <asp:TemplateField HeaderText="流水号"  ItemStyle-CssClass="left Sequence xlstext">
            <ItemTemplate>
                <%#Eval("Number")%>
            </ItemTemplate>
        </asp:TemplateField>
