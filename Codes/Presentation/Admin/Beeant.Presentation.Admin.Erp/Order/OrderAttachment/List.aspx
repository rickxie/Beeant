<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Erp.Order.OrderAttachment.List" MasterPageFile="~/Datum.Master" %>
    ...
    <ContentTemplate>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="编辑" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='update.aspx?id=<%#Eval("Id") %>&orderid=<%#Eval("Order.Id")%>' target="_blank" name="Edit">编辑</a>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="订单编号"  ItemStyle-CssClass="center">
            <ItemTemplate>
                <%#Eval("Order.Id")%>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="附件"  ItemStyle-CssClass="left status">
            <ItemTemplate>
                  <a href="<%#Eval("DownFileUrl") %>" target="_blank"> 下载</a>  
            </ItemTemplate>
        </asp:TemplateField>
