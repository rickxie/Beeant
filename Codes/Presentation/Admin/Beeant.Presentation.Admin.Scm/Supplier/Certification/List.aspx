<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Scm.Supplier.Certification.List" %>
<%@ Register src="../../Controls/Pager.ascx" tagname="Pager" tagprefix="uc1" %>
<%@ Register src="../../Controls/Progress.ascx" tagname="Progress" tagprefix="uc2" %>
<%@ Register src="../../Controls/DataSearch.ascx" tagname="DataSearch" tagprefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <ContentTemplate>
        <div id="divSearch" class="search" runat="server" >
            <table class="tb">
                <uc3:DataSearch ID="DataSearch1" runat="server" />
                <tr>
            ...
            <td class="mtext">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                     ...
                     <asp:ListItem  Value="Supplier.Name" Text="供应商名称"></asp:ListItem>                     
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="详情" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='Detail.aspx?id=<%#Eval("Id") %>&SupplierId=<%=Request.Params["SupplierId"] %>' target="_blank" name="Entity">详情</a>
            </ItemTemplate>
        </asp:TemplateField>
