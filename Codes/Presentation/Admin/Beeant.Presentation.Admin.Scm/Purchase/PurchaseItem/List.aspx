<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Scm.Purchase.PurchaseItem.List" MasterPageFile="~/Main.Master" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <ContentTemplate>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Selected="True" Value="Product.Id" Text="商品" ></asp:ListItem>
            ...
            <td class="mtext" colspan="2">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                   ...
                   <asp:ListItem   Value="Name" Text="名称" ></asp:ListItem>
                     <asp:ListItem   Value="Price" Text="单价" ></asp:ListItem>
        ...
        <div class="mainten">
         ...
         <a href='Create.aspx?PurchaseId=<%=Request.QueryString["PurchaseId"] %>' name="Add" target="_blank"class="btn mbtn" >批量添加</a>
