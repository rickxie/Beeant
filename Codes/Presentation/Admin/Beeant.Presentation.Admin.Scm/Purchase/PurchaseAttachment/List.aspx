<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Scm.Purchase.PurchaseAttachment.List" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="7" class="mtext"> 
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="Purchase.Id" Text="采购单编号" Selected="True"></asp:ListItem>
                     <asp:ListItem  Value="User.Id" Text="操作人标识" Selected="True" ></asp:ListItem>
                     <asp:ListItem  Value="User.RealName" Text="操作人真实姓名" Selected="True" ></asp:ListItem>
                     <asp:ListItem  Value="Name" Text="附件名称(标题)" Selected="True"></asp:ListItem>
                     <asp:ListItem  Value="FileName" Text="附件路径" Selected="True"></asp:ListItem>
         ...
         <tr>
            ...
            <td class="mtext" colspan="2">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                     ...
                     <asp:ListItem  Value="Purchase.Id" Text="采购单编号" ></asp:ListItem>
                     <asp:ListItem  Value="User.Id" Text="操作人标识"  ></asp:ListItem>
                     <asp:ListItem  Value="User.RealName" Text="操作人真实姓名" ></asp:ListItem>
                     <asp:ListItem  Value="Name" Text="附件名称(标题)" ></asp:ListItem>
                     <asp:ListItem  Value="FileName" Text="附件路径" ></asp:ListItem>
        ...
        <div class="mainten">
         <a href="Add.aspx?PurchaseId=<%=Request.QueryString["PurchaseId"] %>" name="Add" target="_blank"class="btn" >添加</a>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="采购单编号"  ItemStyle-CssClass="center">
            <ItemTemplate>
                <%#Eval("Purchase.Id")%>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="操作人标识"  ItemStyle-CssClass="center">
            <ItemTemplate>
                <%#Eval("User.Id")%>
            </ItemTemplate>
        </asp:TemplateField>
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,User.Id"  OrderByExp="Id desc" />
