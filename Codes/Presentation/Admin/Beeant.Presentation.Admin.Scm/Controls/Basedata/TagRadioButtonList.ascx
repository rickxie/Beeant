<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TagRadioButtonList.ascx.cs" Inherits="Beeant.Presentation.Admin.Scm.Controls.Basedata.TagRadioButtonList" %>
