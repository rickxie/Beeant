<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Cloud.Cms.Cms.List" MasterPageFile="~/Main.Master" %>
         ...
         <tr>
            ...
            <td colspan="7" class="mtext"> 
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="IsUsed" Text="是否显示" ></asp:ListItem>
