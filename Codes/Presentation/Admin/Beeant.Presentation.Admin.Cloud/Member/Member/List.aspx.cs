...
{
    public partial class List : ListPageBase<MemberEntity>
    {
        protected override IList<MemberEntity> GetEntities()
        {
        ...
        protected virtual void SetAccounts(IList<MemberEntity> infos)
        {
            var accountIds =
