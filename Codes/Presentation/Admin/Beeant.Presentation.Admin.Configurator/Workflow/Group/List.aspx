<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Configurator.Workflow.Group.List" MasterPageFile="~/Main.Master" %>
 ...
 <input id="IdControl" type="hidden" runat="server" />
       ...
       <Columns>
        ...
        <asp:TemplateField ItemStyle-CssClass="center ckbox">
            ...
            <asp:TemplateField HeaderText="授权流程" ItemStyle-CssClass="center loperate">
            <ItemTemplate>
                <a href='/Workflow/GroupFlow/Add.aspx?groupid=<%#Eval("Id") %>' target="_blank">授权流程</a>
            </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="回收流程" ItemStyle-CssClass="center loperate">
            <ItemTemplate>
                <a href='/Workflow/GroupFlow/Delete.aspx?groupid=<%#Eval("Id") %>' target="_blank">回收流程</a>
            </ItemTemplate>
        </asp:TemplateField>
