<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Beeant.Presentation.Admin.Configurator.Workflow.AuditorAccount.Add" MasterPageFile="~/Datum.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <ContentTemplate>
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,Name,Remark,InsertTime" FromExp="AuditorEntity" />
