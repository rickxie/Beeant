<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Configurator.Authority.Ability.List" MasterPageFile="~/Datum.Master" %>
<%@ Register src="/Controls/Pager.ascx" tagname="Pager" tagprefix="uc1" %>
 ...
 <input id="IdControl" type="hidden" runat="server" />
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,Name,IsVerify,Remark,InsertTime" FromExp="AbilityEntity" />
