<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Beeant.Presentation.Admin.Configurator.Authority.RoleAccount.Add" MasterPageFile="~/Datum.Master" %>

<%@ Import Namespace="Beeant.Presentation.Admin.Configurator.Authority.RoleAccount" %>
<%@ Register src="/Controls/Pager.ascx" tagname="Pager" tagprefix="uc1" %>
<%@ Register src="/Controls/Progress.ascx" tagname="Progress" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
   <title><%=this.GetAccountName()%>授权角色</title>  
 </asp:Content>
 <asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <ContentTemplate>
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,Name,InsertTime" FromExp="RoleEntity" />
