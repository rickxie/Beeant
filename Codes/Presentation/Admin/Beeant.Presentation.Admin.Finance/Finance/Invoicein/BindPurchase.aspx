<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BindPurchase.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Invoicein.BindPurchase" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
         ...
         <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="mtext">
                            <asp:CheckBoxList ID="ckSelectList" runat="server">
                                ...
                                <asp:ListItem Value="Amount" Text="应付金额" Selected="True"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td class="mtext">
                           ...
                           <asp:ListItem Value="Follow.RealName" Text="跟单人"></asp:ListItem>
                            <asp:ListItem Value="Amount" Text="应付金额" ></asp:ListItem>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="本次付款"  ItemStyle-CssClass="right xlsfloat">
                            <ItemTemplate>
                                 <input value='<%#Convert.ToDecimal(Eval("Amount")) - Convert.ToDecimal(Eval("InvoiceAmount")) %>' id="txtPayment" runat="server" type="text" class="input" />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,TotalAmount,InvoiceAmount" OrderByExp="Id desc"   />
