<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Invoicein.List" MasterPageFile="~/Main.Master" %>
        ...
        <tr>
            ...
            <td>
             ...
             <td colspan="4">
                 ...
                 <asp:Button ID="btnExcel" runat="server" Text="导出Excel" CssClass="lmbtn btn" ExcelName="进项发票"  />
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="详情" ItemStyle-CssClass="center operate">
          ...
          <asp:TemplateField HeaderText="处理" ItemStyle-CssClass="center operate">
            ...
            <ItemTemplate>
                <a href='BindPurchase.aspx?id=<%#Eval("Id") %>' target="_blank"  name="Invoice" style='<%#GetWorkflowPropertyVisible(Eval("Status").Convert<int>(),"Invoices",Eval("User.Id").Convert<long>()) %>'>绑定核销</a>
            </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="编辑核销" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='EditBindPurchase.aspx?id=<%#Eval("Id") %>' target="_blank" name="Invoice" style='<%#GetWorkflowPropertyVisible(Eval("Status").Convert<int>(),"Invoices",Eval("User.Id").Convert<long>()) %>'>编辑核销</a>
            </ItemTemplate> 
        </asp:TemplateField>
