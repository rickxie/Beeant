<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Invoiceout.Detail" MasterPageFile="~/Main.Master" %>
 ...
 <div class="info">
   ...
   <a href='handle.aspx?id=<%=RequestId%>'  name="Handle">处理</a>
    ...
    <ContentTemplate>
     ...
     SelectExp="Id,Order.Id,Order.Amount,Order.InvoiceAmount,Amount,IsStatus,Remark"
      FromExp="Order.InvoiceEntity"
      OrderByExp="UpdateTime desc" WhereExp="Invoiceout.Id==@Id" />
