<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BindOrder.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Invoiceout.BindOrder" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
         ...
         <tr>
            ...
            <td class="font">
                        ...
                        <td class="text" colspan="3">
                                <asp:TextBox ID="txtId" runat="server" CssClass="seinput" SearchParamterName="Id" SearchWhere="Id==@Id"></asp:TextBox>
                        </td>
        </tr>
        <tr>
            <td class="font">
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Value="Amount" Text="应收金额"  Selected="True"></asp:ListItem>
                     <asp:ListItem  Value="InvoiceAmount" Text="已开金额"  Selected="True"></asp:ListItem>     
                </asp:CheckBoxList>
            </td>
        ...
        <tr>
            ...
            <td class="mtext">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                     ...
                     <asp:ListItem  Value="Amount" Text="应收金额" ></asp:ListItem>
                     <asp:ListItem  Value="InvoiceAmount" Text="已开金额" ></asp:ListItem>                      
                </asp:DropDownList>
            </td>
            <td class="font">
                排序方式
    ...
    <div class="mainten">
         ...
         <asp:Button ID="btnBindOrder" runat="server" Text="绑定" CssClass="btn mbtn" onclick="btnBindOrder_Click"   ConfirmBox="Price" ConfirmMessage="您确定要修改金额吗" ComfirmCheckBoxMessage="你没有选择任何行"/>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table"  >
       <Columns>
        ...
        <asp:TemplateField HeaderText="本次开票"  ItemStyle-CssClass="left">
            <ItemTemplate>
                <input value='<%# Convert.ToDouble(Eval("Amount").ToString())-Convert.ToDouble(Eval("InvoiceAmount").ToString()) %>' id="txtPrice" runat="server" type="text" class="input" />                
            </ItemTemplate>
        </asp:TemplateField>  
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"  SelectExp="Id,OpenAmount,InvoiceAmount" OrderByExp="Id desc"   />     
