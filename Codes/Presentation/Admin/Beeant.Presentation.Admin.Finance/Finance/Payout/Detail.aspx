<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Payout.Detail" MasterPageFile="~/Main.Master" %>
   ...
   <a href='handle.aspx?id=<%=RequestId%>'  name="Handle">处理</a>
    ...
    <ContentTemplate>
     ...
     <uc1:Pager ID="pgHistory" runat="server" PageSize="10"  SelectExp="Id,StatusName,DataEntity,ToUser.RealName,HandleUser.RealName,LevelName,Remark,InsertTime" FromExp="HistoryEntity" OrderByExp="UpdateTime desc" WhereExp="DataId==@Id && FlowId==@FlowId" />
         ...
         <div class="subtitle" onclick="SetEntityBody('divPaid')">核销列表(<span class="count"><%=puPaid.DataCount%></span>)
        </div>
    ...
    <ContentTemplate>
     <div  class="search" >
           ...
           <asp:GridView ID="gvPaid" runat="server" AutoGenerateColumns="False" CssClass="table" >
       <Columns> 
                        ...
                        <asp:TemplateField HeaderText="已付金额"  ItemStyle-CssClass="left">
                            <ItemTemplate>
                                <%#Eval("Purchase.PaidAmount")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="本次支付"  ItemStyle-CssClass="left">
                            <ItemTemplate>
                                 <%#Eval("Amount")%>
                            </ItemTemplate>
                        </asp:TemplateField>
     ...
     <uc1:Pager ID="puPaid" runat="server" PageSize="10"  
     SelectExp="Id,Purchase.Id,Purchase.Amount,Purchase.PaidAmount,Amount,IsStatus,Remark"
      FromExp="PaidEntity"
      OrderByExp="UpdateTime desc" WhereExp="Payout.Id==@Id" />
