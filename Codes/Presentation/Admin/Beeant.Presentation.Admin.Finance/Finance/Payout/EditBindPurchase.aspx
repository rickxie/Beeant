<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditBindPurchase.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Payout.EditBindPurchase" %>
                ...
                <table class="tb">
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="mtext">
                            <asp:CheckBoxList ID="ckSelectList" runat="server">
                                ...
                                <asp:ListItem Value="Purchase.TotalAmount" Text="金额" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="Purchase.PayAmount" Text="已付金额" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="Amount" Text="本次支付" Selected="True"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td class="mtext">
                            ...
                            <asp:ListItem Value="Purchase.TotalAmount" Text="金额" ></asp:ListItem>
                            <asp:ListItem Value="Purchase.PayAmount" Text="已付金额" ></asp:ListItem>
                            <asp:ListItem Value="IsStatus" Text="状态"></asp:ListItem>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="金额"  ItemStyle-CssClass="right xlsfloat">
                            <ItemTemplate>
                                <%#Eval("Purchase.TotalAmount")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="已付金额"  ItemStyle-CssClass="right xlsfloat">
                            <ItemTemplate>
                                <%#Eval("Purchase.PayAmount")%>
                            </ItemTemplate>
                        </asp:TemplateField>
