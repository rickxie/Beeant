<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditBindOrder.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Payin.EditBindOrder" %>
        ...
        <ContentTemplate>
                    ...
                    <td colspan="7" class="mtext">
                        <asp:CheckBoxList ID="ckSelectList" runat="server">
                             <asp:ListItem  Value="Order.Id" Text="订单编号" Selected="True"></asp:ListItem>
                              <asp:ListItem  Value="Order.TotalAmount" Text="应付款" Selected="True"></asp:ListItem>
                             <asp:ListItem  Value="Order.PayAmount" Text="已付款" Selected="True"></asp:ListItem>
            ...
            <td class="mtext">
                <asp:DropDownList ID="ddlOrderbyList" runat="server">
                            ...
                            <asp:ListItem  Value="Order.TotalAmount" Text="应付款" ></asp:ListItem>
                             <asp:ListItem  Value="Order.PayAmount" Text="已付款" ></asp:ListItem>
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField ItemStyle-CssClass="center ckbox">
                        ...
                        <asp:TemplateField HeaderText="应付款" ItemStyle-CssClass="center operate">
                              <ItemTemplate>
                                  <%#Eval("Order.TotalAmount") %>
                              </ItemTemplate>
                          </asp:TemplateField>
                        <asp:TemplateField HeaderText="已付款" ItemStyle-CssClass="center operate">
                            <ItemTemplate>
