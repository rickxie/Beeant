<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Payin.List" MasterPageFile="~/Main.Master" %>
        ...
        <tr>
            ...
            <td colspan="7" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server">
                     ...
                     <asp:ListItem  Value="PayTime" Text="到账日期" Selected="True" ></asp:ListItem>
                     <asp:ListItem  Value="SourceAmount" Text="原币种金额" Selected="True" ></asp:ListItem>
                      <asp:ListItem  Value="PayType" Text="收款方式" ></asp:ListItem>
       ...
       <Columns>
        ...
        <asp:TemplateField HeaderText="详情" ItemStyle-CssClass="center operate">
         ...
         <asp:TemplateField HeaderText="打印" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='PrintDetail.aspx?id=<%#Eval("Id") %>' target="_blank" name="Entity">打印</a>
            </ItemTemplate>
        </asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="绑定核销" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='BindOrder.aspx?id=<%#Eval("Id") %>' target="_blank" name="Received"  >绑定核销</a>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="编辑核销" ItemStyle-CssClass="center operate">
            <ItemTemplate>
                <a href='EditBindOrder.aspx?id=<%#Eval("Id") %>' target="_blank" name="Received" >编辑核销</a>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="到账日期"  ItemStyle-CssClass="left Sequence">
            <ItemTemplate>
                <%#Eval("PayTime")%>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="收款方式"  ItemStyle-CssClass="left Sequence">
            <ItemTemplate>
                <%#Eval("PayType")%>
            </ItemTemplate>
        </asp:TemplateField>
