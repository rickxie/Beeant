<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TagCheckBoxList.ascx.cs" Inherits="Beeant.Presentation.Admin.Finance.Controls.Basedata.TagCheckBoxList" %>
