<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistrictDropDownList.ascx.cs" Inherits="Beeant.Presentation.Admin.Wms.Controls.Basedata.DistrictDropDownList" %>
