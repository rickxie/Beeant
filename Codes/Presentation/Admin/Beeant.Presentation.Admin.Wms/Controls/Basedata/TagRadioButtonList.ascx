<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TagRadioButtonList.ascx.cs" Inherits="Beeant.Presentation.Admin.Wms.Controls.Basedata.TagRadioButtonList" %>
