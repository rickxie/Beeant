<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Beeant.Presentation.Admin.Log.Log.Error.Detail" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
 ...
 <div class="info">
     <table class="tb">
         <tr>
             <td class="font">错误信息</td>
             <td class="mtext" colspan="3"><asp:Label ID="lblMessage" runat="server" BindName="Message"></asp:Label></td>
         </tr>
         <tr>
             <td class="font">地址</td>
