<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Log.Log.Operation.List" MasterPageFile="~/Main.Master" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
         ...
         <tr>
            ...
            <td colspan="8" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="Address" Text="Address" Selected="True"></asp:ListItem>
  ...
  <asp:TemplateField HeaderText="详情"  ItemStyle-CssClass="left status">
            <ItemTemplate>
               <a href='Detail.aspx?id=<%#Eval("Id") %>' target="_blank">详情</a> 
            </ItemTemplate>
        </asp:TemplateField>
