<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Beeant.Presentation.Admin.Log.Log.Login.List" MasterPageFile="~/Main.Master" %>
    ...
    <ContentTemplate>
        ...
        <tr>
            ...
            <td colspan="8" class="mtext">
                <asp:CheckBoxList ID="ckSelectList" runat="server" >
                     ...
                     <asp:ListItem  Value="City" Text="城市" Selected="True"></asp:ListItem>
       ...
       <Columns>
        ...
        <asp:TemplateField ItemStyle-CssClass="center ckbox">
            ...
            <ItemTemplate>
              <%#Eval("Type")%>
                    ...
                    <asp:TemplateField HeaderText="城市"  ItemStyle-CssClass="left name">
            <ItemTemplate>
              <%#Eval("City")%>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="地址"  ItemStyle-CssClass="left name">
            <ItemTemplate>
               <a href='Detail.aspx?id=<%#Eval("Id") %>' target="_blank"><%#Eval("Address")%></a> 
            </ItemTemplate>
        </asp:TemplateField>
     ...
     <uc1:Pager ID="Pager1" runat="server" PageSize="10"   SelectExp="Id,Address" />
