...
function SelectDate(obj,strFormat,retFormat,x,y) 
{ 
...
if (retFormat && retFormat.length > 0)
    cal.retDateFormatStyle = retFormat;
else 
    cal.retDateFormatStyle = strFormat;
...
: new Date();//2008-01-29 
calendar.ReturnDate(today.format(calendar.retDateFormatStyle && calendar.retDateFormatStyle.length > 0 ? calendar.retDateFormatStyle : calendar.dateFormatStyle));
} 
