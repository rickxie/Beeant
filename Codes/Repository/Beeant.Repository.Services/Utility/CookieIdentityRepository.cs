...
{
    public class CookieIdentityRepository : IdentityRepository
    {
        /// <summary>
        /// 加密至
        /// </summary>
        ...
        {
            get { return Configuration.ConfigurationManager.GetSetting<string>("Keys").DeserializeJson<dynamic>().Decrypt3Des.ToString(); }
        ...
        public override TokenEntity Set<T>(T info) 
        {
            ...
            var cookie = new HttpCookie(token.Ticket) { Expires = DateTime.Now.AddMinutes(token.TimeOut) };
