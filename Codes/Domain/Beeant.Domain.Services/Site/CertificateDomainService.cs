...
{
    public class CertificateDomainService : RealizeDomainService<CertificateEntity>
    {
        ...
        /// <returns></returns>
        protected override bool ValidateAdd(CertificateEntity info)
        {
        ...
        /// <returns></returns>
        protected virtual bool ValidateSite(CertificateEntity info)
        {
