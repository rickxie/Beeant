...
{
    public class BannerDomainService : RealizeDomainService<BannerEntity>
    {
        ...
        /// <returns></returns>
        protected override bool ValidateAdd(BannerEntity info)
        {
        ...
        /// <returns></returns>
        protected virtual bool ValidateSite(BannerEntity info)
        {
