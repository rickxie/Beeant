...
{
    public class OrderNumberDomainService : RealizeDomainService<OrderNumberEntity>
    {

        #region 加载
        private IDictionary<string, ItemLoader<OrderNumberEntity>> _itemLoaders;
        /// <summary>
        /// 处理
        /// </summary>
        protected override IDictionary<string, ItemLoader<OrderNumberEntity>> ItemLoaders
        {
            get
            {
                return _itemLoaders ?? (_itemLoaders = new Dictionary<string, ItemLoader<OrderNumberEntity>>
                    {
                        {"Order", LoadOrder},
        ...
        /// <returns></returns>
        protected override bool SetBusiness(IList<IUnitofwork> unitofworks, OrderNumberEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected virtual void LoadDataEntity(OrderNumberEntity info)
        {
            if (info.SaveType == SaveType.Add) return;
            info.DataEntity = Repository.Get<OrderNumberEntity>(info.Id);
        ...
        /// </summary>
        /// <param name="info"></param>
        protected virtual void LoadOrder(OrderNumberEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected override bool ValidateAdd(OrderNumberEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected virtual bool ValidateOrder(OrderNumberEntity info)
        {
