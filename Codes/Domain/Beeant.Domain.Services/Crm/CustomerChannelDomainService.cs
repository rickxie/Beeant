...
{
    public class CustomerChannelDomainService : RealizeDomainService<CustomerChannelEntity>
    {
        ...
        /// <returns></returns>
        protected override bool ValidateAdd(CustomerChannelEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected override bool ValidateRemove(CustomerChannelEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected virtual bool ValidateCustomers(CustomerChannelEntity info)
        {
        ...
        /// <returns></returns>
        protected virtual bool ValidateCrm(CustomerChannelEntity info)
        {
