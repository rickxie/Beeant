...
{
    public class ImageDomainService : RealizeDomainService<ImageEntity>
    {
        ...
        /// <returns></returns>
        protected override bool ValidateAdd(ImageEntity info)
        {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected virtual bool ValidateAccount(ImageEntity info)
        {
        ...
        /// <returns></returns>
        protected virtual bool ValidateFolder(ImageEntity info, ImageEntity dataEntity)
        {
            ...
            if (info.Folder != null && info.Folder.Id != 0)
            {
                ...
                if (folder.Type != FolderType.Image)
                {
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        protected override bool ValidateModify(ImageEntity info)
        {
            var dataEntity = Repository.Get<ImageEntity>(info.Id);
