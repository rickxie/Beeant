...
namespace Winner.Queue.Distributed
{
    ...
    public class XmlDistributedQueue : DistributedQueue
    {
        #region 属性
        /// <summary>
        /// 节点名称
        ...
        public XmlDistributedQueue(string clientFile, string configFile)
        {
        ...
        protected virtual void AddNodeByXml(XmlDocument doc,IList<EndPointInfo> endPoints)
        {
            ...
            foreach (XmlNode nd in nodes)
            {
                if (nd.Attributes != null)
                    AddNode(endPoints.FirstOrDefault(it=>it.Name.Equals(nd.Attributes["Name"].Value)), Convert.ToInt32(nd.Attributes["NodeCount"].Value));
            }
        }
        #endregion
