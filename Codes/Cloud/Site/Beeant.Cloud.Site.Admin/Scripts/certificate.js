$(document).ready(function () {
    ...
    function removeCertificate(sender) {//删除
        if (!confirm("您确定要删除吗"))
            return false;
    ...
    function downCertificate(sender) {
        if (!window.checkSaveTag(sender)) {
            return false;
        }
        var id = $(sender).attr("DataId");
