...
define('zrender/zrender', [
    ...
    Wms.prototype.iterShape = function (fun, option) {
        if (!option) {
    ...
    Wms.prototype.getHoverShapes = function (update) {
        var hoverElements = [];
        for (var i = 0, l = this._hoverElements.length; i < l; i++) {
    ...
    Wms.prototype.getShapeList = function (update) {
        if (update) {
            this.updateShapeList();
        }
        return this._shapeList;
    };
    Wms.prototype.updateShapeList = function () {
        this._shapeListOffset = 0;
    ...
    Wms.prototype._updateAndAddShape = function (el, clipShapes) {
        if (el.ignore) {
            return;
        }
        el.updateTransform();
    ...
    Wms.prototype.mod = function (el, params) {
        if (typeof el === 'string') {
    ...
    Wms.prototype.drift = function (shapeId, dx, dy) {
    ...
    Wms.prototype.addHover = function (shape) {
        shape.updateNeedTransform();
        this._hoverElements.push(shape);
        return this;
    };
    Wms.prototype.delHover = function () {
        this._hoverElements = [];
        return this;
    };
    Wms.prototype.hasHoverShape = function () {
        return this._hoverElements.length > 0;
    };
    Wms.prototype.addRoot = function (el) {
        if (this._elements[el.id]) {
            return;
        }
        if (el instanceof Group) {
            el.addChildrenToWms(this);
        }
        this.addToMap(el);
        this._roots.push(el);
    };
    Wms.prototype.delRoot = function (elId) {
        if (typeof elId == 'undefined') {
            for (var i = 0; i < this._roots.length; i++) {
                var root = this._roots[i];
                if (root instanceof Group) {
                    root.delChildrenFromWms(this);
                }
            }
            this._elements = {};
            this._hoverElements = [];
        ...
        if (idx >= 0) {
            ...
            if (el instanceof Group) {
                el.delChildrenFromWms(this);
            }
        }
    };
    Wms.prototype.addToMap = function (el) {
        if (el instanceof Group) {
            el._storage = this;
        }
        el.modSelf();
    ...
    Wms.prototype.get = function (elId) {
        return this._elements[elId];
    };
    Wms.prototype.delFromMap = function (elId) {
    ...
    Wms.prototype.dispose = function () {
    ...
    Group.prototype.addChild = function (child) {
        ...
        if (this._storage && this._storage !== child._storage) {
            ...
            if (child instanceof Group) {
                child.addChildrenToWms(this._storage);
            }
        }
    };
    Group.prototype.removeChild = function (child) {
        ...
        if (this._storage) {
            ...
            if (child instanceof Group) {
                child.delChildrenFromWms(this._storage);
            }
        }
    };
    ...
    Group.prototype.addChildrenToWms = function (storage) {
        for (var i = 0; i < this._children.length; i++) {
            var child = this._children[i];
            storage.addToMap(child);
            if (child instanceof Group) {
                child.addChildrenToWms(storage);
            }
        }
    };
    Group.prototype.delChildrenFromWms = function (storage) {
        for (var i = 0; i < this._children.length; i++) {
            var child = this._children[i];
            storage.delFromMap(child.id);
            if (child instanceof Group) {
                child.delChildrenFromWms(storage);
            }
        }
    };
