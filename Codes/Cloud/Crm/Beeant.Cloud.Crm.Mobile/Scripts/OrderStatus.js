$(document).ready(function () {
    ...
    function removeOrderStatus(sender) {//删除
        if (!confirm("您确定要删除吗"))
            return;
    ...
    function downOrderStatus(sender) {
        if (!window.checkSaveTag(sender)) {
            return;
        }
        var id = $(sender).attr("DataId");
